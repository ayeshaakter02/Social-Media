    ...
    <div className="max-w-146.25 mx-auto bg-white rounded-[15px] mt-8.25 font-poppins">
      ...
      <div className="flex">
        <div
          ...
          className={`flex justify-center items-center gap-4 px-27 py-7.25 font-inter font-bold text-xs flex-1 cursor-pointer ${activeTab === "status"
        ...
        <div
          ...
          className={`flex justify-center items-center gap-4 px-20.75 whitespace-nowrap py-7.25 font-inter font-bold text-xs flex-1 cursor-pointer ${activeTab === "product"
      ...
      {activeTab === "product" && (
        <div className="pl-5.25 pr-5.5 pt-7.25 space-y-2.5 border-t border-[#D9D9D9]">
          ...
          {/* Buttons */}
          <div className="grid grid-cols-2 gap-2.5">
            <button className="input bg-[#24234B] hover:bg-[#1877F2] text-white ">
              Image Preview
            </button>
            <button className="input bg-[#24234B] hover:bg-[#1877F2] text-white">
              Image Thumbnail
              ...
              <div key={i} className="flex gap-1">
                <div className="grid grid-cols-2 gap-2.5 mb-2">
                  <input
                    ...
                    className="input w-[256px] outline-none"
                  />
                  <input
